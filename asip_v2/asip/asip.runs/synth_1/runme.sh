...
HD_PWD='/home/knutjb/Vivado/asip_kj/asip/asip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OneCycleCPUwithIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OneCycleCPUwithIO.tcl
