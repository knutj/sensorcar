...
HD_PWD='/home/knutjb/Vivado/onecpuio/onecpuio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OneCycleCPUwithIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OneCycleCPUwithIO.tcl -notrace
