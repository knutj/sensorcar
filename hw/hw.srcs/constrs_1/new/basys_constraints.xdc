...
set_property PACKAGE_PIN K3 [get_ports max_t]
set_property PACKAGE_PIN L3 [get_ports {mc_q[8]}]
set_property PACKAGE_PIN M3 [get_ports {mc_q[7]}]
set_property PACKAGE_PIN M2 [get_ports {mc_q[6]}]
set_property PACKAGE_PIN M1 [get_ports {mc_q[5]}]
set_property PACKAGE_PIN N2 [get_ports {mc_q[4]}]
set_property PACKAGE_PIN N1 [get_ports {mc_q[3]}]
set_property PACKAGE_PIN N3 [get_ports {mc_q[2]}]
set_property PACKAGE_PIN P3 [get_ports {mc_q[1]}]
set_property PACKAGE_PIN P1 [get_ports {mc_q[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {mc_q[0]}]
